    ...
    <>
      {
        ...
        loading ? (
          ...
          <div className="xs:w-[95vw] sm:w-[90vw] md:w-full md:max-w-screen-xl mx-auto my-6">
            <div className="flex xs:justify-start xs:items-start xs:p-4 md:p-8 md:mx-4 md:justify-between md:items-start border-2 xs:flex-col md:flex-row ">
              <div className="md:w-2/3 xs:w-full relative md:border-r-1 md:pr-2 ">
                ...
                <button
                  ...
                  className="z-20 absolute top-0 right-2 md:right-4 w-4 h-4"
                >
              ...
              <div className="md:w-1/2 xs:w-full flex flex-col md:justify-between md:pl-4 md:ml-4 h-full">
                ...
                <div className="flex gap-2 items-baseline mb-4">
                  ...
                  {product.discount ? (
                    <span className="text-sm text-red-500 md:px-2">
                ...
                <div className="flex flex-col mb-4 ">
                  <div className="flex gap-2 items-baseline">
                    ...
                    <p className="xs:text-xs sm:text-base">
                      {" "}
                  ...
                  <p className="text-gray-500 text-sm">
                    {product.orders
                      ? product.orders + ` bought in past month`
                      : ""}{" "}
                  </p>
                </div>
                <div className="md:w-1/2 flex justify-start items-baseline my-2">
                  ...
                  <button
                    onClick={decCount}
                    className="w-1/6 text-sm border-2 border-gray-500 hover:text-white hover:bg-black "
                  >
                    -
                  </button>
                  <p className="w-1/6 text-sm text-center border-t-2 border-b-2 border-gray-500">
                    {count}
                  </p>
                  <button
                    onClick={incCount}
                ...
                <div className="flex justify-between flex-col items-baseline ">
                  ...
                  {/* Buy now button */}
                  <button className="xs:w-full sm:w-1/2 md:w-2/3 lg:w-1/2 py-2 mt-1 border-2 border-black hover:text-white hover:bg-black text-sm uppercase tracking-wider">
                    {" "}
                    Buy now
                  </button>
                </div>
            ...
            <p className="text-2xl mt-16 uppercase  md:mx-4">
              You may also like
            </p>
